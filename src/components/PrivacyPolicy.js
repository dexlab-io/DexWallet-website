    ...
    <Container className="section">
      <div className="container is-size-6">
        ...
        <div className="content is-size-5">
          ...
          <p>
            We respect and protect the privacy of our Users. Dexlab Sagl, a wholly owned entity of Dex Ventures Ltd, will collect and use your Personal Information, generated from your use of DexWallet, in accordance with this Privacy Policy (“Policy”).
            DexLab recommends that you shall carefully read and understand the whole contents of this Policy before you use the product (“DexWallet”). 
          </p>
          <p>
            ...
            Via Balestra 12 
            6900 Lugano (CH)
            Owner contact email: getintouch@dexlab.io
          </p>
          ...
          <ol>
            <div className="list-heading">In particular, Users have the right to do the following:</div>
            The Owner may process Personal Data relating to Users if one of the following applies:
            <li>
          ...
          <div className="list-heading">Details about the right to object to processing</div>
          <p>
          ...
          <div className="list-heading">Additional information about User's Personal Data</div>
          <p>
          ...
          <div className="list-heading">Information not contained in this policy</div>
          <p>
