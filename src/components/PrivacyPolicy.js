    ...
    <Container className="section">
      <div className="container is-size-6">
        <div className="content is-size-5">
          ...
          <p>
            We respect and protect the privacy of our Users. Dexlab Sagl, a
            wholly owned entity of Dex Ventures Ltd, will collect and use your
            Personal Information, generated from your use of DexWallet, in
            accordance with this Privacy Policy (“Policy”). DexLab recommends
            that you shall carefully read and understand the whole contents of
            this Policy before you use the product (“DexWallet”).
          </p>
          <p>
            ...
            Owner and Data Controller Dexlab Sagl Via Balestra 12 6900 Lugano
            (CH) Owner contact email: getintouch@dexlab.io
          </p>

          <div className="list-heading">Types of Data collected</div>
          <p>
          ...
          <p>
            ...
            described in the present document. Users are responsible for any
          ...
          <p>
            ...
            processing of Personal Data. Users are also entitled to learn about
            the legal basis of Data transfers to a country outside the European
          ...
          <ol>
            <div className="list-heading">Retention time</div>
            <p>
          ...
          <div className="list-heading">The rights of Users</div>
          <p>
          ...
          <p>
            ...
            action The User's Personal Data may be used for legal purposes by
            the Owner in Court or in the stages leading to possible legal action
          ...
          <p>
            ...
            contact information at the beginning of this document. How “Do Not
            Track” requests are handled This Application does not support “Do
            Not Track” requests. To determine whether any of the third-party
          ...
          <p>
            ...
            the bottom. Should the changes affect processing activities
            performed on the basis of the User’s consent, the Owner shall
